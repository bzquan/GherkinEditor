...
namespace UnitTestProject
{
    ...
    public class GraphVizWrapperTest
    {
        ...
        public void Initialize()
        {
            ...
            //wrapper.GraphvizPath = @"C:\Program Files\Graphviz2.38\bin";
            wrapper.GraphvizPath = @"C:\Program Files (x86)\Graphviz2.39\bin\";
        }
        ...
        [TestMethod]
        public void GraphvizPlainTest()
        {
            // When
            byte[] output = wrapper.GenerateGraphDirectly("digraph{a -> b; b -> c; c -> a;}", Enums.GraphReturnType.Plain);
