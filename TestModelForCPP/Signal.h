...
namespace bdd {
	...
	{
        typedef _signal_base0<mt_policy> TBase;
    public:
		signal0()
		{
			;
			...
			void connect(desttype* pclass, void (desttype::*pmemfun)())
		{
            ...
            TBase::m_connected_slots.push_back(conn);
		...
		{
			lock_block<mt_policy> lock(this);
            for (typename TBase::connections_list::const_iterator iter = TBase::m_connected_slots.begin(); iter != TBase::m_connected_slots.end(); ++iter)
            {
                (*iter)->emit();
            }
		}
	...
	{
        typedef _signal_base1<arg1_type, mt_policy> TBase;
    public:
		signal1()
		{
			;
	...
	{
        typedef _signal_base2<arg1_type, arg2_type, mt_policy> TBase;
	public:
		signal2()
		{
			;
	...
	{
        typedef _signal_base3<arg1_type, arg2_type, arg3_type, mt_policy> TBase;
	public:
		signal3()
		{
			;
	...
	{
        typedef _signal_base4<arg1_type, arg2_type, arg3_type, arg4_type, mt_policy> TBase;
    public:
		signal4()
		{
			;
	...
	{
        typedef _signal_base5<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, mt_policy> TBase;
    public:
		signal5()
		{
			;
	...
	{
        typedef _signal_base6<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, arg6_type, mt_policy> TBase;
    public:
		signal6()
		{
			;
	...
	{
        typedef _signal_base7<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, arg6_type, arg7_type, mt_policy> TBase;
    public:
		signal7()
		{
			;
			...
			arg5_type a5, arg6_type a6, arg7_type a7)
		{
            ...
            for (typename TBase::connections_list::const_iterator iter = TBase::m_connected_slots.begin(); iter != TBase::m_connected_slots.end(); ++iter)
            {
                (*iter)->emit(a1, a2, a3, a4, a5, a6, a7);
            }
		}
	...
	{
        typedef _signal_base8<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, arg6_type, arg7_type, arg8_type, mt_policy> TBase;
    public:
		signal8()
		{
			;
			...
			arg5_type a5, arg6_type a6, arg7_type a7, arg8_type a8)
		{
            ...
            for (typename TBase::connections_list::const_iterator iter = TBase::m_connected_slots.begin(); iter != TBase::m_connected_slots.end(); ++iter)
            {
                (*iter)->emit(a1, a2, a3, a4, a5, a6, a7, a8);
            }
		}
